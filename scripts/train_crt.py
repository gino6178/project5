...
cfg = CRTConfig(epochs=120, batch=128, lr=2.0e-4, d_model=384, n_blocks=6, heads=8,
                w_recon=1.0, w_terminal=1.0, w_monotone=0.2, w_relation=2.0,
                workers=0, out="outputs/crt")
